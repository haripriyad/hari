...
public class AddressBookController {
    ...
    private void openAdd(){   
       view.getMainGUIFrame().setVisible(false);
        ...
        choiceListener = new ActionListener() {
            ...
            String place = contactDetailsPanel.getPlaceField().getText();
            flag = validate();
            if(flag)
            {    
             Person person = new Person();
             person.setData(name,mobile,email,place);
   ...
   */
    ...
    private void openEdit(){
        ...
        dialog.getPanel().setPlace(detailPanel.getPlaceField().getText());
        view.getMainGUIFrame().setVisible(false);
        choiceListener = new ActionListener() {
            @Override
            public void actionPerformed(ActionEvent e) {
     ...
     private void openSearch(){
       ...
       String reply = JOptionPane.showInputDialog(null,"Enter the String:","Search",1);
     }      
